...
// trashPaths moves paths to Trash and aggregates results.
func trashPaths(paths []string, counter *int64) (int64, error) {
...
func deleteMultiplePathsCmd(paths []string, counter *int64) tea.Cmd {
	return func() tea.Msg {
		count, err := trashPaths(paths, counter)
